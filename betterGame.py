...
#function ==> checks if move is valid -> checks symbol -> places the piece at bottom
...
# checks the available moves for the game
...
#checks if the player has won or some shit bruh i am tired
...
# Starts the game and everything dude why u reading this code in detail hugagbakgbrgb
def play_game():
